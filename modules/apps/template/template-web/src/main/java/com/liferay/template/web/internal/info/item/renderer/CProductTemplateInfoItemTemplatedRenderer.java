...
public class CProductTemplateInfoItemTemplatedRenderer
	extends BaseTemplateInfoItemTemplatedRenderer<CProduct>
	implements InfoItemTemplatedRenderer<CProduct> {

	@Override
	public List<InfoItemRendererTemplate> getInfoItemRendererTemplates(
		CProduct cProduct, Locale locale) {

		return getInfoItemRendererTemplates(CProduct.class.getName(), locale);
	}
	...
	public String getInfoItemRendererTemplatesGroupLabel(
		...
		return getInfoItemRendererTemplatesGroupLabel(
			CProduct.class.getName(), locale);
	}

	@Override
	public void render(
		CProduct cProduct, String templateKey,
		HttpServletRequest httpServletRequest,
		HttpServletResponse httpServletResponse) {

		renderTemplate(
			CProduct.class.getName(), cProduct, templateKey, httpServletRequest,
			httpServletResponse);
	}
