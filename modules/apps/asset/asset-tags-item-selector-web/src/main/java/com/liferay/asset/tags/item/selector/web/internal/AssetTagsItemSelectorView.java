...
import com.liferay.asset.tags.item.selector.web.internal.AssetTagsItemSelectorViewDescriptor;
	...
	public void renderHTML(
		...
		AssetTagsDisplayContext assetTagsDisplayContext =
			new AssetTagsDisplayContext(
				_itemSelector, httpServletRequest,  portletURL,
				renderResponse ,renderRequest, assetTagsItemSelectorCriterion);

		_itemSelectorViewDescriptorRenderer.renderHTML(
			httpServletRequest, servletResponse,
			assetTagsItemSelectorCriterion, portletURL, itemSelectedEventName,
			search,
			new AssetTagsItemSelectorViewDescriptor(assetTagsItemSelectorCriterion,
				httpServletRequest, assetTagsDisplayContext));
	}
