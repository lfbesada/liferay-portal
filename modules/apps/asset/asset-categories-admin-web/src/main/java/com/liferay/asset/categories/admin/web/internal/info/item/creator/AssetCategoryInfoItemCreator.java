 ...
 * @author Rubén Pulido
 */
@Component(immediate = true, service = InfoItemCreator.class)
public class AssetCategoryInfoItemCreator
	...
	public AssetCategory createFromInfoItemFieldValues(
		...
		throws InfoItemCreationException {
		...
		try {
			...
			throw new InfoItemCreationException(
				"Cannot create InfoItem of type AssetCategory",
				portalException);
		}
	}
