...
public class AssetCategoryLocalServiceTest {
	...
	public void setUp() throws Exception {
		...
		_assetVocabulary = _assetVocabularyLocalService.addVocabulary(
			TestPropsValues.getUserId(), _group.getGroupId(), "A Vocabulary",
			new ServiceContext());
	}
	...
	public void testAddCategory() throws PortalException {
		String expectedCategoryName = "Title-spain-translation";
	...
	public void testAddCategoryExistsTranslationInDefaultSiteLocale()
		...
		Map<Locale, String> titleMap = HashMapBuilder.put(
			LocaleUtil.FRANCE, "Title-france-translation"
		).put(
		...
		AssetCategory category = _assetCategoryLocalService.addCategory(
			...
			HashMapBuilder.put(
				LocaleUtil.FRANCE, "Description-france-translation"
			).put(
				LocaleUtil.SPAIN, "Description-spain-translation"
			).build(),
	...
	public void testUpdateCategoryExistsTranslationInDefaultSiteLocale()
		...
		AssetCategory category = _assetCategoryLocalService.addCategory(
			TestPropsValues.getUserId(), _group.getGroupId(),
			"Title-spain-translation", _assetVocabulary.getVocabularyId(),
			new ServiceContext());
