...
public class AssetPublisherConfigurationAction
	...
	protected void updateAssetListEntryPreferences(
		...
		if (assetListEntry.getGroupId() == themeDisplay.getScopeGroupId()) {
			...
			setPreference(
				actionRequest, "assetListEntryScopeExternalReferenceCode",
				group.getExternalReferenceCode());
		}
	}

	protected void updateDisplayStyleScopePreferences(
			ActionRequest actionRequest, PortletPreferences portletPreferences)
		throws Exception {
		...
		if ((group != null) &&
			...
			setPreference(
				actionRequest, "displayStyleScopeExternalReferenceCode",
				group.getExternalReferenceCode());
		}
		else {
			portletPreferences.reset("displayStyleScopeExternalReferenceCode");
		}
	}
	...
	private void _setSelectionStyle(
		...
		updateDisplayStyleScopePreferences(actionRequest, portletPreferences);
	}
