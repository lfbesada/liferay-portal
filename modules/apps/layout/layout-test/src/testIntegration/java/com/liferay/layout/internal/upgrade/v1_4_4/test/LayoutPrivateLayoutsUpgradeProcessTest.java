...
public class LayoutPrivateLayoutsUpgradeProcessTest {
	...
	public void testUpgrade() throws Exception {
		...
		String featureFlagValue = portalPreferences.getValue(
		...
		try {
			...
			Assert.assertFalse(FeatureFlagManagerUtil.isEnabled("LPD-38869"));
			...
			Assert.assertTrue(FeatureFlagManagerUtil.isEnabled("LPD-38869"));
