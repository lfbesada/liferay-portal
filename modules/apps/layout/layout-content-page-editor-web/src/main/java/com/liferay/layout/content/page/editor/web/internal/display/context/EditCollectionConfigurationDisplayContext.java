...
public class EditCollectionConfigurationDisplayContext {
	...
	public Map<String, Object> getData() throws Exception {
		return HashMapBuilder.<String, Object>put(
			"collectionConfig", _getCollectionConfigJSONObject()
		).put(
			...
			() -> {
				...
				return HttpComponentsUtil.addParameter(url, "type", getType());
			}
		).put(
	...
	private JSONObject _getCollectionConfigJSONObject() throws Exception {
		...
		if (collectionJSONObject.has("config")) {
			return collectionJSONObject.getJSONObject("config");
		}
