...
public class GetCollectionVariationsMVCResourceCommand
	...
	protected void doServeResource(
		...
		JSONPortletResponseUtil.writeJSON(
			...
			_getCollectionVariationsJSONObject(resourceRequest));
	}

	private Object _getCollectionVariationsJSONObject(
		...
		if (assetListEntryId <= 0) {
			return JSONUtil.put("variations", Collections.emptyList());
		}
		...
		List<String> segmentEntryNames = new LinkedList<>();
		...
		if (!_assetListEntryModelResourcePermission.contains(
				themeDisplay.getPermissionChecker(), assetListEntryId,
				ActionKeys.UPDATE)) {

			return JSONUtil.put("variations", segmentEntryNames);
		}
		...
		return JSONUtil.put(
			...
			PortletURLBuilder.create(
				_portal.getControlPanelPortletURL(
					resourceRequest, themeDisplay.getScopeGroup(),
