...
}: AddRuleProps): Promise<Array<{layoutData: LayoutData}>> {
...
function deleteRule({
	...
	ruleId,
	segmentsExperienceId,
}: DeleteRuleProps): Promise<Array<{layoutData: LayoutData}>> {
	return draftServiceFetch(
...
function updateRule({
	...
	ruleId,
	segmentsExperienceId,
}: UpdateRuleProps): Promise<Array<{layoutData: LayoutData}>> {
	return draftServiceFetch(
