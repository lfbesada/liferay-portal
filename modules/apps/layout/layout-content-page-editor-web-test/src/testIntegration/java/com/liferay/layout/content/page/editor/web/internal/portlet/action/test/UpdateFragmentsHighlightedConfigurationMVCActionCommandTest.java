...
public class UpdateFragmentsHighlightedConfigurationMVCActionCommandTest {
	...
	public void testUpdateFragmentsHighlightedConfiguration() throws Exception {
		_assertUpdateHighlightedFragment(
			new String[] {"BASIC_COMPONENT-heading"}, "BASIC_COMPONENT-heading",
			true, TestPropsValues.getUser());
		_assertUpdateHighlightedFragment(
			new String[] {"BASIC_COMPONENT-heading", "BASIC_COMPONENT-html"},
			"BASIC_COMPONENT-html", true, TestPropsValues.getUser());
		_assertUpdateHighlightedFragment(
			new String[] {"BASIC_COMPONENT-heading"}, "BASIC_COMPONENT-html",
			false, TestPropsValues.getUser());
		_assertUpdateHighlightedFragment(
			new String[0], "BASIC_COMPONENT-heading", false,
