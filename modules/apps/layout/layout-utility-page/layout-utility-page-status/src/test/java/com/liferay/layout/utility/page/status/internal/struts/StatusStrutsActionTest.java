...
public class StatusStrutsActionTest {
	...
	public void testExecuteWithThemeWithoutElementWithIdContent()
		...
		Mockito.verify(
			...
			"Theme " + _layoutSet.getThemeId() +
				" lacks a 'content' ID, replacing all body content"
		);
	...
	private static MockedStatic<ServletResponseUtil>
		_getServletResponseUtilMockedStatic() {

		PropsUtil.setProps(new PropsImpl());

		return Mockito.mockStatic(ServletResponseUtil.class);
	}
	...
	private static final MockedStatic<ServletResponseUtil>
		_servletResponseUtilMockedStatic =
			_getServletResponseUtilMockedStatic();
