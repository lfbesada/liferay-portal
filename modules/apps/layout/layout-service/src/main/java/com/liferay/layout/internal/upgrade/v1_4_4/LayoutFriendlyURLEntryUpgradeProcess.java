...
public class LayoutFriendlyURLEntryUpgradeProcess extends UpgradeProcess {
	...
	private boolean _checkFriendlyURLEntryMapping(
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(
				StringBundler.concat(
					"select 1 from FriendlyURLEntryMapping where ",
					"ctCollectionId = ", ctCollectionId, " and classNameId = ",
	...
	private long _getFriendlyURLEntryId(
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(
				StringBundler.concat(
					...
					"ctCollectionId = ", ctCollectionId, " and groupId = ",
					groupId, " and companyId = ", companyId, " and ",
	...
	private Map<String, String> _getFriendlyURLMap(
			long companyId, long ctCollection, long groupId, long plid,
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(
				StringBundler.concat(
					...
					"where ctCollectionId = ", ctCollection, " and groupId = ",
					groupId, " and companyId = ", companyId, " and plid = ",
					plid, " and privateLayout = ? "))) {

			preparedStatement.setBoolean(1, privateLayout);
