...
public class LayoutInfoItemObjectProviderTest {
	...
	public void testGetInfoItem() throws Exception {
		InfoItemObjectProvider<Object> infoItemObjectProvider =
			_infoItemServiceRegistry.getFirstInfoItemService(
				InfoItemObjectProvider.class, Layout.class.getName());

		Assert.assertEquals(
			_layout,
			infoItemObjectProvider.getInfoItem(
				_group.getGroupId(),
				new ClassPKInfoItemIdentifier(_layout.getPlid())));
		Assert.assertEquals(
			_layout,
			infoItemObjectProvider.getInfoItem(
				_group.getGroupId(),
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LayoutInfoItemObjectProviderTest.class);
