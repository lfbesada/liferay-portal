...
>
	<clay:sheet-header>
		...
		<p class="sheet-text"><liferay-ui:message key="admins-can-manually-unlock-pages-that-are-being-used-by-other-users.-please-note-that-the-current-user-may-lose-control-over-the-page-edition-if-you-unlock-it" /></p>
	</clay:sheet-header>
