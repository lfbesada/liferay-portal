		...
		>
			<clay:sheet-section>
				...
				if (layoutSEOEntry != null) {
					layoutSEOEntryCustomMetaTags = LayoutSEOEntryCustomMetaTagLocalServiceUtil.getLayoutSEOEntryCustomMetaTags(layoutSEOEntry.getGroupId(), layoutSEOEntry.getLayoutSEOEntryId());
				}
