...
public class FileEntryInfoItemFieldValuesProviderTest {
	...
	private void _registerFileEntryInfoItemFieldReader() {
		TestFileEntryInfoItemFieldReader fileEntryInfoItemFieldReader =
			new TestFileEntryInfoItemFieldReader();

		Registry registry = RegistryUtil.getRegistry();

		_serviceRegistration = registry.registerService(
			(Class<InfoItemFieldReader<FileEntry>>)
				(Class<?>)InfoItemFieldReader.class,
			fileEntryInfoItemFieldReader);
	}
	...
	private ServiceRegistration<InfoItemFieldReader<FileEntry>>
