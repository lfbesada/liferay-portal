...
import com.liferay.headless.admin.content.client.serdes.v1_0.PageRuleSerDes;
...
public class PageRule implements Cloneable, Serializable {
	...
	public void setRuleId(
		UnsafeSupplier<String, Exception> ruleIdUnsafeSupplier) {

		try {
			ruleId = ruleIdUnsafeSupplier.get();
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
