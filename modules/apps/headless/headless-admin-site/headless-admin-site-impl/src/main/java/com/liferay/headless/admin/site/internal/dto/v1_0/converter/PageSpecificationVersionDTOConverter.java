...
public class PageSpecificationVersionDTOConverter
	...
	private PageSpecificationVersionPageExperience[]
		...
		Map<String, List<String>> languageIdsBySegmentsExperienceERC =
			new HashMap<>();
		...
		for (LayoutContentVersionPreview layoutContentVersionPreview :
			...
			List<String> languageIds =
				languageIdsBySegmentsExperienceERC.computeIfAbsent(
					layoutContentVersionPreview.getSegmentsExperienceERC(),
					key -> new ArrayList<>());

			languageIds.add(layoutContentVersionPreview.getLanguageId());
		}
			...
			pageExperience -> {
				...
				pageSpecificationVersionPageExperience.
					setAvailablePreviewLanguageIds(
						() -> {
							List<String> languageIds =
								languageIdsBySegmentsExperienceERC.getOrDefault(
