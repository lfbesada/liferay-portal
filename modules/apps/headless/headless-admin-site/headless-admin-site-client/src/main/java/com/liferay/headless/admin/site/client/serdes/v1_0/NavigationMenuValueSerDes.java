...
public class NavigationMenuValueSerDes {
	...
	public static String toJSON(NavigationMenuValue navigationMenuValue) {
		...
		if (navigationMenuValue.getNavigationMenu() != null) {
			...
			sb.append(String.valueOf(navigationMenuValue.getNavigationMenu()));
		}

		if (navigationMenuValue.getParentItemExternalReferenceCode() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
		...
		if (navigationMenuValue.getPrivatePages() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(navigationMenuValue.getPrivatePages());
		}
	...
	public static Map<String, String> toMap(
		...
		if (navigationMenuValue.getNavigationMenu() == null) {
			map.put("navigationMenu", null);
		}
		else {
			map.put(
				"navigationMenu",
				String.valueOf(navigationMenuValue.getNavigationMenu()));
		}

		if (navigationMenuValue.getParentItemExternalReferenceCode() == null) {
			map.put("parentItemExternalReferenceCode", null);
		}
		else {
			map.put(
		...
		if (navigationMenuValue.getPrivatePages() == null) {
			map.put("privatePages", null);
		}
		else {
			map.put(
				"privatePages",
				String.valueOf(navigationMenuValue.getPrivatePages()));
		}
	...
	public static class NavigationMenuValueJSONParser
		...
		protected NavigationMenuValue createDTO() {
			return new NavigationMenuValue();
		}
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "navigationMenu")) {
				return false;
			}
			...
			else if (Objects.equals(jsonParserFieldName, "privatePages")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "navigationMenu")) {
				...
				if (jsonParserFieldValue != null) {
					navigationMenuValue.setPrivatePages(
