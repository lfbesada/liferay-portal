...
import com.liferay.headless.admin.site.client.serdes.v1_0.CollectionConfigurationFieldValueSerDes;
...
public class CollectionConfigurationFieldValue
	...
	public static CollectionConfigurationFieldValue toDTO(String json) {
		return CollectionConfigurationFieldValueSerDes.toDTO(json);
	}
	...
	@Override
	public CollectionConfigurationFieldValue clone()
		throws CloneNotSupportedException {

		return (CollectionConfigurationFieldValue)super.clone();
	}
	...
	public String toString() {
		return CollectionConfigurationFieldValueSerDes.toJSON(this);
	}
