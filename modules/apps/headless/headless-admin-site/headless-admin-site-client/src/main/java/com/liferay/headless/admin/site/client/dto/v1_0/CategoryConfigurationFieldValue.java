...
import com.liferay.headless.admin.site.client.serdes.v1_0.CategoryConfigurationFieldValueSerDes;
...
public class CategoryConfigurationFieldValue
	...
	public static CategoryConfigurationFieldValue toDTO(String json) {
		return CategoryConfigurationFieldValueSerDes.toDTO(json);
	}
	...
	@Override
	public CategoryConfigurationFieldValue clone()
		throws CloneNotSupportedException {

		return (CategoryConfigurationFieldValue)super.clone();
	}
	...
	public String toString() {
		return CategoryConfigurationFieldValueSerDes.toJSON(this);
	}
