...
@Generated("")
@GraphQLName(
	description = "The value of a configuration field of type color palette.",
	value = "ColorPaletteConfigurationFieldValue"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ColorPaletteConfigurationFieldValue")
public class ColorPaletteConfigurationFieldValue
	...
	public static ColorPaletteConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ColorPaletteConfigurationFieldValue.class, json);
	}

	public static ColorPaletteConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ColorPaletteConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the configuration field of type color palette."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the configuration field of type color palette."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.ColorPaletteConfigurationFieldValue",
		name = "x-class-name"
	)
