...
@Generated("")
@GraphQLName(
	description = "The value of a configuration field of type navigation menu.",
	value = "NavigationMenuConfigurationFieldValue"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "NavigationMenuConfigurationFieldValue")
public class NavigationMenuConfigurationFieldValue
	...
	public static NavigationMenuConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			NavigationMenuConfigurationFieldValue.class, json);
	}

	public static NavigationMenuConfigurationFieldValue unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the configuration field of type navigation menu."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the configuration field of type navigation menu."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.NavigationMenuConfigurationFieldValue",
		name = "x-class-name"
	)
