...
@Generated("")
@GraphQLName(
	description = "The value of a configuration field of type category.",
	value = "CategoryConfigurationFieldValue"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CategoryConfigurationFieldValue")
public class CategoryConfigurationFieldValue
	...
	public static CategoryConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			CategoryConfigurationFieldValue.class, json);
	}

	public static CategoryConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			CategoryConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the configuration field of type category."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the configuration field of type category."
	)
	@Valid
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CategoryConfigurationFieldValue)) {
			return false;
		}

		CategoryConfigurationFieldValue categoryConfigurationFieldValue =
			(CategoryConfigurationFieldValue)object;

		return Objects.equals(
			toString(), categoryConfigurationFieldValue.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.CategoryConfigurationFieldValue",
		name = "x-class-name"
	)
