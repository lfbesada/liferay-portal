...
@Generated("")
@GraphQLName(
	description = "The value of a configuration field of type item.",
	value = "ItemConfigurationFieldValue"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ItemConfigurationFieldValue")
public class ItemConfigurationFieldValue
	...
	public static ItemConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ItemConfigurationFieldValue.class, json);
	}

	public static ItemConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ItemConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the configuration field of type item."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the configuration field of type item."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.ItemConfigurationFieldValue",
		name = "x-class-name"
	)
