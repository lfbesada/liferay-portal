...
@Generated("")
@GraphQLName(
	description = "The value of a configuration field of type video.",
	value = "VideoConfigurationFieldValue"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "VideoConfigurationFieldValue")
public class VideoConfigurationFieldValue
	...
	public static VideoConfigurationFieldValue toDTO(String json) {
		return ObjectMapperUtil.readValue(
			VideoConfigurationFieldValue.class, json);
	}

	public static VideoConfigurationFieldValue unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			VideoConfigurationFieldValue.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The value of the configuration field of type video."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized value of the configuration field of type video."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.VideoConfigurationFieldValue",
		name = "x-class-name"
	)
