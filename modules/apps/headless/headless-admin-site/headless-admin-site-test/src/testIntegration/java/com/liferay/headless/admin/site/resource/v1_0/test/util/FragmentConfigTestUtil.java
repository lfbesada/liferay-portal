...
public class FragmentConfigTestUtil {
	...
	public static Map<String, ConfigurationFieldValue> getFragmentConfigMap(
		...
		for (FragmentConfigurationField fragmentConfigurationField :
			FragmentEntryConfigurationParserUtil.getFragmentConfigurationFields(
				configurationJSONObject)) {

			Object object = objectsMap.get(fragmentConfigurationField.getName());

			if (object == null) {
				continue;
			}

			map.put(fragmentConfigurationField.getName(), getConfigurationFieldValue(
	...
	public static ColorPaletteValue getColorPaletteValue(JSONObject jsonObject) {
	...
	public static ConfigurationFieldValue getColorPaletteConfigurationFieldValue(
		boolean localizable, Object object) {

		ColorPaletteConfigurationFieldValue colorPaletteConfigurationFieldValue =
	...
	public static ConfigurationFieldValue getCollectionConfigurationFieldValue(
		...
		CollectionReference collectionReference = ReferencesTestUtil.getCollectionReference(
			object, scopeGroupId
		);
	...
	public static ConfigurationFieldValue getCategoryConfigurationFieldValue(
		...
		ItemExternalReference itemExternalReference = ReferencesTestUtil.getItemExternalReference(
			object, scopeGroupId
		);
	...
	public static ConfigurationFieldValue getItemConfigurationFieldValue(
		...
		ItemValue itemValue = new
			ItemValue() {{
				...
				setTemplate(() -> new TemplateReference() {
					{
						setRendererKey(
							() -> GetterUtil.getString(objectMap.get(
								"infoItemRendererKey")));
						setTemplateKey(
