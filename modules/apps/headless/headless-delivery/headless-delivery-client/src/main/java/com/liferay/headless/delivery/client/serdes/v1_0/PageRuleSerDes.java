...
public class PageRuleSerDes {
	...
	public static String toJSON(PageRule pageRule) {
		...
		if (pageRule.getRuleId() != null) {
			...
			sb.append(_escape(pageRule.getRuleId()));
	...
	public static Map<String, String> toMap(PageRule pageRule) {
		...
		if (pageRule.getRuleId() == null) {
			...
			map.put("ruleId", String.valueOf(pageRule.getRuleId()));
		}
	...
	public static class PageRuleJSONParser extends BaseJSONParser<PageRule> {
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "ruleId")) {
				if (jsonParserFieldValue != null) {
					pageRule.setRuleId((String)jsonParserFieldValue);
				}
			}
		}
