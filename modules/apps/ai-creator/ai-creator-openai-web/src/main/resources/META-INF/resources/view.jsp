...
<aui:script>
	...
	createButton.addEventListener('click', (event) => {
			var fields = {
				<portlet:namespace />content: document.getElementById('<portlet:namespace />content').value,
				<portlet:namespace />words: document.getElementById('<portlet:namespace />words').value,
				<portlet:namespace />tone: document.getElementById('<portlet:namespace />tone').value
			};
