		...
		for (Map.Entry<Class<?>, String[]> entry : map.entrySet()) {
			...
			for (String expandoValue : expandoValues) {
				...
				if (clazz.equals(BlogsEntry.class)) {
					...
					DDMStructure ddmStructure = _ddmStructureLocalService.getStructure(_group.getGroupId(), _portal.getClassNameId(JournalArticle.class.getName()), "BASIC-WEB-CONTENT", true);
