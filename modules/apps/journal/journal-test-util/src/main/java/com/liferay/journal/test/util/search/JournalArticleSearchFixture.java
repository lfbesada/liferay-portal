...
public class JournalArticleSearchFixture {
	...
	public JournalArticle addArticle(
		...
		DDMStructure ddmStructure = _ddmStructureLocalService.fetchStructure(
			journalArticleBlueprint.getGroupId(), _portal.getClassNameId(JournalArticle.class.getName()), "BASIC-WEB-CONTENT", true);

		return addArticle(
			journalArticleBlueprint, ddmStructure.getStructureId(), "BASIC-WEB-CONTENT");
	}
