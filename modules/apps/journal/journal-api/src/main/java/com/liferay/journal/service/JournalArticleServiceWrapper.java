...
public class JournalArticleServiceWrapper
	 ...
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link #addArticle(String, long, long, long, long, String, boolean, Map, Map, Map, String, long, String, String, int, int, int, int, int, int, int, int, int, int, boolean, int, int, int, int, int, boolean, boolean, boolean, String, File, Map, String, ServiceContext)}
	 */
	@Deprecated
	@Override
	public JournalArticle addArticle(
	 ...
	 * @return the web content article
	 * @throws PortalException if a portal exception occurred
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link #addArticle(String, long, long, Map, Map, String, long, String, ServiceContext)}
	 */
	@Deprecated
	@Override
	public JournalArticle addArticle(
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link #addArticleDefaultValues(long, long, long, Map, Map, String, long, String, String, int, int, int, int, int, int, int, int, int, int, boolean, int, int, int, int, int, boolean, boolean, boolean, String, File, ServiceContext)}
	 */
	@Deprecated
	@Override
	public JournalArticle addArticleDefaultValues(
