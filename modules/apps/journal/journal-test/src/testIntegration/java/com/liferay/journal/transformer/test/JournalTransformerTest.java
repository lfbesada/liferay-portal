...
public class JournalTransformerTest {
	...
	private DDMFormField _createDDMFormField(
			Locale locale, boolean multiple, Map<String, String> optionsMap,
			String type)
		throws Exception {
		...
		label.addString(locale, RandomTestUtil.randomString(10));
		...
		for (Map.Entry<String, String> entry : optionsMap.entrySet()) {
			...
			ddmFormFieldOptions.addOptionLabel(optionKey, locale, optionLabel);
		}
