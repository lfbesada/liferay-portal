...
@Component(
	property = {
		...
		"mvc.command.name=/journal/save_journal_article_ai_creator_company_configuration"
	},
	service = MVCActionCommand.class
)
public class SaveJournalArticleAICreatorCompanyConfigurationMVCActionCommand
