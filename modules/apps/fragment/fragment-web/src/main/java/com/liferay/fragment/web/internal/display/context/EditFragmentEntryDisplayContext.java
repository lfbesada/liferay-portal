	...
	private JSONArray _getFieldTypesJSONArray() {
		...
		try {
			JSONObject propertiesJSONObject = JSONFactoryUtil.createJSONObject(
				fragmentEntry.getProperties());

			fieldTypesJSONArray = propertiesJSONObject.getJSONArray(
				"fieldTypes");
		}
		...
		return JSONUtil.putAll(
			_getFieldTypeJSONObject(
				BooleanInfoFieldType.INSTANCE, fieldTypesJSONArray),
			_getFieldTypeJSONObject(
				DateInfoFieldType.INSTANCE, fieldTypesJSONArray),
			_getFieldTypeJSONObject(
				NumberInfoFieldType.INSTANCE, fieldTypesJSONArray),
			_getFieldTypeJSONObject(
				SelectInfoFieldType.INSTANCE, fieldTypesJSONArray),
			_getFieldTypeJSONObject(
				TextInfoFieldType.INSTANCE, fieldTypesJSONArray));
	}
