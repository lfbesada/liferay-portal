...
public class FragmentsImporterTest {
	...
	public void testImportFragmentResourcesPreservesIdentifiersWithPropagation()
		...
		try (CompanyConfigurationTemporarySwapper
			...
			long originalFileEntryId = originalFileEntry.getFileEntryId();
			String originalUuid = originalFileEntry.getUuid();
			...
			Assert.assertEquals(
				originalFileEntryId, reimportedFileEntry.getFileEntryId());
			Assert.assertEquals(originalUuid, reimportedFileEntry.getUuid());
			Assert.assertEquals(
