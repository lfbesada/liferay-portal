...
/**
 * Provides the local service utility for FragmentEntryPropagation. This utility wraps
 * <code>com.liferay.fragment.service.impl.FragmentEntryPropagationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FragmentEntryPropagationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.fragment.service.impl.FragmentEntryPropagationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FragmentEntryPropagation addFragmentEntryPropagation(
		FragmentEntryPropagation fragmentEntryPropagation) {

		return getService().addFragmentEntryPropagation(
	 ...
	 */
	public static FragmentEntryPropagation createFragmentEntryPropagation(
		long fragmentEntryPropagationId) {

		return getService().createFragmentEntryPropagation(
	 ...
	 */
	public static FragmentEntryPropagation deleteFragmentEntryPropagation(
		FragmentEntryPropagation fragmentEntryPropagation) {

		return getService().deleteFragmentEntryPropagation(
			fragmentEntryPropagation);
	}
	...
	public static FragmentEntryPropagation fetchFragmentEntryPropagation(
		...
		return getService().fetchFragmentEntryPropagation(
			fragmentEntryPropagationId);
	}
	 ...
	 * @throws PortalException if a fragment entry propagation with the primary key could not be found
	 */
	public static FragmentEntryPropagation getFragmentEntryPropagation(
			long fragmentEntryPropagationId)
		throws PortalException {

		return getService().getFragmentEntryPropagation(
			fragmentEntryPropagationId);
	}
	 ...
	 */
	public static List<FragmentEntryPropagation> getFragmentEntryPropagations(
		int start, int end) {

		return getService().getFragmentEntryPropagations(start, end);
	}
	 ...
	 */
	public static int getFragmentEntryPropagationsCount() {
		return getService().getFragmentEntryPropagationsCount();
	}
	 ...
	 */
	public static FragmentEntryPropagation updateFragmentEntryPropagation(
		FragmentEntryPropagation fragmentEntryPropagation) {

		return getService().updateFragmentEntryPropagation(
			fragmentEntryPropagation);
	}

	public static FragmentEntryPropagationLocalService getService() {
		return _service;
	}

	private static volatile FragmentEntryPropagationLocalService _service;
