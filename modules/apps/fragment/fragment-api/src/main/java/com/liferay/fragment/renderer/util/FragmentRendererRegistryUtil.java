...
public class FragmentRendererRegistryUtil {
	...
	public static FragmentRenderer getFragmentRenderer(String key) {
		FragmentRendererRegistry fragmentRendererRegistry = _fragmentRendererRegistrySnapshot.get();
	...
	public static FragmentRendererRegistry
	getFragmentRendererRegistry() {
	...
	private static final Snapshot<FragmentRendererRegistry>
		...
		FragmentRendererRegistryUtil.class,
		FragmentRendererRegistry.class);
}
