...
/**
 * Provides the local service interface for FragmentEntryPropagation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FragmentEntryPropagationLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface FragmentEntryPropagationLocalService
	extends BaseLocalService, CTService<FragmentEntryPropagation>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.fragment.service.impl.FragmentEntryPropagationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fragment entry propagation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FragmentEntryPropagationLocalServiceUtil} if injection and service tracking are not available.
	 */
