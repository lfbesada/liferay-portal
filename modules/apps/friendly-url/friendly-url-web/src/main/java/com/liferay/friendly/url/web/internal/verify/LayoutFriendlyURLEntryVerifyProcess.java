...
package com.liferay.friendly.url.web.internal.verify;
...
public class LayoutFriendlyURLEntryVerifyProcess extends VerifyProcess {
	...
	private long _addFriendlyURLEntryIfAbsentAndGetId(
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(
			...
			long friendlyURLEntryId = _counterLocalService.increment(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LayoutFriendlyURLEntryVerifyProcess.class);
