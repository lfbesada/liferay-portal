...
package com.liferay.friendly.url.internal.verify.test;
...
public class LayoutFriendlyURLEntryVerifyProcessTest
	...
	public void testUpgradeProcess() throws Exception {
		...
		_assertVerify(draftLayout1, draftLayout2, layout1, layout2);
	}
	...
	private void _assertVerify(Layout... layouts) throws Exception {
		doVerify();
	...
	@Inject(
		filter = "component.name=com.liferay.friendly.url.web.internal.verify.LayoutFriendlyURLEntryVerifyProcess"
	)
