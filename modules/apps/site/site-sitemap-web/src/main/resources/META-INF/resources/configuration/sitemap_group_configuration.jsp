	...
	>
		...
		>
			<c:if test="<%= sitemapGroupConfigurationDisplayContext.isIncludePagesDisabled() %>">
				<clay:alert
					message="to-enable-the-inclusion-of-page-urls-in-the-xml-sitemap,-it-must-also-be-enabled-from-instance-settings"
				/>
			</c:if>
	...
	>
		...
		>
			<c:if test="<%= sitemapGroupConfigurationDisplayContext.isIncludeCategoriesDisabled() %>">
				<clay:alert
					message="to-enable-the-inclusion-of-category-urls-in-the-xml-sitemap,-it-must-also-be-enabled-from-instance-settings"
				/>
			</c:if>
