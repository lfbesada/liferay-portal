...
@Component(
	...
	service = {DDMDisplayTabItem.class, WidgetTemplatesTabItem.class}
)
public class WidgetTemplatesTabItem extends BaseTemplatesTabItem {

	@Override
	public String getTabId() {
		return TemplatesPortletKeys.WIDGET_TEMPLATE_TAB_ID;
	}
